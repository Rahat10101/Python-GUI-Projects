...
class GUIwindow():
    ...
    def createUI(self, master):
        ...
        self.widthScale = ttk.Scale(self.controlFrame, orient=HORIZONTAL, from_=1, to_=self.screenWidth - 200, length=1024, variable=self.widthVar, command=self.changeWidth)
        ...
        self.heightScale = ttk.Scale(self.controlFrame, orient=HORIZONTAL, from_=1, to_=self.screenHeight - 200,  length=1024, variable=self.heightVar, command=self.changeHeight)
